...
const DashboardCharts = () => {
    ...
    return (
        <section className="grid grid-cols-1 gap-3 xl:grid-cols-[1fr_1.35fr_1fr]">
            <article className="rounded-lg border border-slate-200 bg-white p-3 shadow-[0_1px_3px_rgba(15,23,42,0.04)] ring-1 ring-white">
                <div className="flex items-center justify-between">
                    <h2 className="text-base font-bold text-slate-950">Income vs Expense</h2>
                    <button className="rounded-md border border-slate-200 bg-slate-50 px-2 py-1 text-xs font-bold text-slate-600 shadow-[0_1px_2px_rgba(15,23,42,0.03)]" type="button">This Month</button>
                </div>
            ...
            <article className="overflow-x-auto rounded-lg border border-slate-200 bg-white p-3 shadow-[0_1px_3px_rgba(15,23,42,0.04)] ring-1 ring-white">
                <div className="flex items-center justify-between">
                    <h2 className="text-base font-bold text-slate-950">Recent Transactions</h2>
                    <button className="rounded-md border border-slate-200 bg-slate-50 px-2 py-1 text-xs font-bold text-slate-600 shadow-[0_1px_2px_rgba(15,23,42,0.03)]" type="button">View All</button>
                </div>
                    ...
                    <tbody>
                        {transactions.map((transaction) => (
                            <tr key={transaction[1]}>
                                ...
                                <td className="border-b border-slate-100 px-2 py-2"><span className="rounded-full bg-emerald-50 px-2 py-1 text-[11px] font-bold text-emerald-600">Completed</span></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
